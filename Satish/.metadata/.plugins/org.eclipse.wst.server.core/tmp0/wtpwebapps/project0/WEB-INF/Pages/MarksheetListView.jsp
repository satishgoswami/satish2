...
<div class="row d-flex justify-content-center h-100">
	<div class="col-lg-12 col-sm-12 ml-auto mr-auto">
		<div class="card card-table">
			<h3 class="w-100 text-center under-over-line" style="color: #8A2BE2;">
...
<sf:select path="studentId" class="form-control border-left-right">
								<sf:option value="0">
									<s:message code="label.selectstudent" />
								</sf:option>
									...
									<c:forEach items="${list}" var="marksheet" varStatus="ct">
										...
										<tr>
											...
											<td class="text-center"><c:url var="editUrl"
												...
												class="btn btn-outline-success btn-block btn-round w-100" style="border-color:#8A2BE2;color:#8A2BE2;"
