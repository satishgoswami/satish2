...
<%@page import="in.co.rays.project0.ctl.MarksheetCtl"%>
...
<div>
     ...
     <div align="center">
		  ...
		  <div class="modal-header justify-content-center" >
           ...
           <s:message code="label.getmarksheet"></s:message>
            </h5>
          </div>
          </div>
...
<sf:form method="post" commandName="form" name="frm">
     ...
     <div class="row">
				...
				<label for="disabledTextInput"><strong><s:message code="label.rollNo"></s:message></strong><font
							color="red">*</font>
						</label>
				</div>
               ...
               <sf:input path="rollNo" class="form-control" placeholder="${enterrollno}"/>
                ...
                <abbr title="${search}">
                <button type="submit" class="btn btn-primary btn-block" name="operation" value="Search" >
