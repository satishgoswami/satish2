...
<article class="card-body">
	...
	<h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.userRegistration"></s:message>
	</h4>
 ...
 <c:if test="${error != null}">
   ...
   <sf:hidden path="id" />
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.email" />
    <span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
	...
	<div align="left" style="color:#8A2BE2;  for="validationDefault02"><s:message code="label.password" />
	<span style="color: red">*</span></div>
	<div class="input-group">
	<div class="input-group-prepend">
	...
	<div align="left" style="color:#8A2BE2;  for="validationDefault02"><s:message code="label.confirmpassword" />
	<span style="color: red">*</span></div>
	<div class="input-group">
	<div class="input-group-prepend">
    <span class="input-group-text"> <i class="fa fa-lock"></i> </span></div>
 ...
 <sf:label path="gender">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.dob" />
    <span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.mobileNo" />
    <span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
	...
	<div align="left"><font style="color: red" ><sf:errors path="mobileNo" />
	 ...
	 <button type="submit" name="operation" style="float: left;width: 100px; margin-left: 50px;"  value="SignUp"  class="btn btn-primary btn-block button2 msgBtn" ><s:message code="label.signup" />
	 </button>
