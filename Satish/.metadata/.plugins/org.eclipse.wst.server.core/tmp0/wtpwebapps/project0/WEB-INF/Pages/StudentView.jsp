...
<article class="card-body">
	...
	<c:choose>
    <c:when test="${form.id==0}"><h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.addstudent" /></h4></c:when>
         <c:otherwise><h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.updatestudent"></s:message></h4>
         </c:otherwise>
           		</c:choose> 
