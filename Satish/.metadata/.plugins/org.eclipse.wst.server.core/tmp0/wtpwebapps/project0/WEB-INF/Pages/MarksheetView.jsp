...
<article class="card-body">
	<c:choose>
<c:when test="${form.id==0}"><h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.addmarksheet" /></h4></c:when>
<c:otherwise><h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.updatemarksheet"></s:message></h4>
</c:otherwise>
</c:choose> 
 ...
 <c:if test="${error != null}">
   ...
   <sf:hidden path="id" />
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.rollNo" /><span style="color: red">*</span></div>
   ...
   <sf:label path="rollNo">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.name" /><span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.physics" /><span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
  ...
  <sf:label path="physics">
	...
	<div align="left" style="color:#8A2BE2;  for="validationDefault02"><s:message code="label.chemistry" /><span style="color: red">*</span></div>
	<div class="input-group">
	<div class="input-group-prepend">
	...
	<div align="left" style="color:#8A2BE2;  for="validationDefault02"><s:message code="label.maths" /><span style="color: red">*</span></div>
	<div class="input-group">
	<div class="input-group-prepend">
    <span class="input-group-text"> <i class='fas fa-star'></i> </span></div>
	 <sf:label path="maths">
