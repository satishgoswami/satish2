...
<a href="<c:url value="/Registration"></c:url>" class="float-right btn btn-outline-success"><s:message code="label.userRegistration"></s:message></a>

	<h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.login"></s:message></h4>
  ...
  <b>${error}</b>
	...
	<p class="text-center"><a href="<c:url value="ForgotPassword"/>" class="btn" title="this is for recover password"><s:message
						code="label.forgetpassword" />?</a></p>
	</div>
