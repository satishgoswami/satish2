								...
								<tr>
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Course/AddCourse?id=" />
              							<a class="btn btn-outline-success btn-block btn-round w-100" style="border-color: #8A2BE2; color: #8A2BE2;" href="${editUrl}${course.id}"><i class="fa fa-edit" aria-hidden="true"></i><s:message code="label.edit"/></a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
