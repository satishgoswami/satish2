...
<c:choose>
<c:when test="${form.id==0}"><h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.addsubject" /></h4></c:when>
<c:otherwise><h4 class="card-title text-center mb-4 mt-1" style="color: #C71585;"><s:message code="label.updatesubject"></s:message></h4>
</c:otherwise>
</c:choose> 
<hr>
 ...
 <c:if test="${error != null}">
  ...
  <div class="form-group">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.coursename"/>
