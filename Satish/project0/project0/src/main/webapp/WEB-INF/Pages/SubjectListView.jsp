					...
					<div class="col-lg-12 table-responsive">
						<table class="table table-hover table-striped border border-secondary">
							<thead style="background-color: #4B0082;">
								<tr>
							 	...
							 	<th scope="col" class="text-center" style="color: white;"><s:message code="label.name"/></th>
						 			<th scope="col" class="text-center" style="color: white;"><s:message code="label.coursename"/></th>
							...
							<c:forEach items="${list}" var="subject" varStatus="ct">
								<tr>
									<td class="text-center">
										<input class="checkbox" name="chk_1" type="checkbox" value="${subject.id}">
									</td>
									<td class="text-center">
									...
									<c:if test="${subject.courseId==cou.id}">
						   ...
						   <td class="text-center">${subject.description}</td>
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Subject/AddSubject?id=" />
              							<a class="btn btn-outline-success btn-block btn-round w-100" style="border-color: #8A2BE2; color: #8A2BE2;" href="${editUrl}${subject.id}"><i class="fa fa-edit" aria-hidden="true"></i><s:message code="label.edit"/></a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
