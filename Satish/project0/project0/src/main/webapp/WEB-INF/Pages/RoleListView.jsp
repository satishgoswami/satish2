...
<div class="row d-flex justify-content-center h-100">
	<div class="col-lg-12 col-sm-12 ml-auto mr-auto">
		<div class="card card-table" style="background-color:#ffffff0d;">
					...
					<div class="col-lg-12 table-responsive">
						<table class="table table-hover table-striped border border-secondary">
							<thead style="background-color: #4B0082;">
								<tr>
									<th scope="col" class="text-center text-white" style="color: white;"><input
								 ...
								 <th scope="col" class="text-center" style="color: white;"><s:message code="label.name"/></th>
									...
									<th scope="col" class="text-center" style="width: 10%;color: white;"><s:message code="label.edit"/></th>
								</tr>
							</thead >
								...
								<tr>
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Role/AddRole?id=" />
              							<a class="btn btn-outline-success btn-block btn-round w-100" style="border-color: #8A2BE2; color: #8A2BE2;" name="operation" href="${editUrl}${role.id}"><i class="fa fa-edit" aria-hidden="true"></i><s:message code="label.edit"/></a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
