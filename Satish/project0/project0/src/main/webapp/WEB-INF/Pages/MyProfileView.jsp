...
<c:choose>
           			<c:when test="${form.id==0}"><h4 style="color: #C71585;"><s:message code="label.myprofile" /></h4></c:when>
           			<c:otherwise><h4 style="color: #C71585;"><s:message code="label.myprofile" /></h4></c:otherwise>
           		</c:choose> 
 ...
 <c:if test="${error != null}">
   ...
   <sf:hidden path="id" />
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.email" /><span style="color: red">*</span></div>
   ...
   <sf:label path="login">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.firstName" /><span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
   ...
   <sf:label path="firstName">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.lastName" /><span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
    <span class="input-group-text"> <i class="fas fa-user"></i> </span></div>
   ...
   <sf:label path="lastName">
    ...
    <div align="left" style="color:#8A2BE2; " for="validationDefault02"><s:message code="label.gender"/><span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
...
<div class="row">
<div class="clo-sm-6">
	<button type="submit" name="operation" style="float: left;width: 80px; "  value="save"  class="btn btn-primary btn-block button2 msgBtn" ><s:message code="label.save"/></button>
	</div>	 
	<div class="clo-sm-6">
	<button type="submit" name="operation" style="width: 80px;margin-left: 20px; width: 180px;" value="ChangePassword"  class="btn btn-primary btn-block button2" ><s:message code="label.changepassword"/></button>
	 </div>
	 </div>
